...
@section('page-subtitle', 'Perbarui detail untuk jenis surat: ' . $suratJeni->nama)
...
<div class="max-w-4xl mx-auto">
    ...
    <form action="{{ route('admin.surat-jenis.update', $suratJeni) }}" method="POST" class="space-y-6">
        @method('PUT')
        @include('admin.surat_jenis._form', ['suratJeni' => $suratJeni])
    </form>
</div>
@endsection