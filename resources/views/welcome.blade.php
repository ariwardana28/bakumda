    ...
    <div class="grid grid-cols-1 gap-3 md:gap-6 mb-4 md:mb-8 relative z-7">
        ...
        <div id="banner-slider-container"
            ...
            <div class="absolute bottom-3 right-4 z-30 flex space-x-1.5" id="slider-dots">
                ...
                <button class="dot h-2 w-2 bg-white/50 rounded-full transition-all duration-300" data-index="3"></button>
            </div>
        </div>
            ...
            <a href="#"
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-start">
                            <span class="text-[9px] md:text-[10px] text-slate-400 font-black tracking-wider">BAKUMDA</span>
                            <div class="w-2.5 h-2.5 rounded-full bg-amber-400 shadow-[0_0_10px_rgba(251,191,36,0.9)]"></div>
                        </div>
                        <div
                ...
                <div
                    ...
                    <span class="text-[11px] text-blue-300 font-medium">Pastikan Anda Telah Memiliki Sertifikat DIKLATKUM
        ...
        <div>
            ...
            <div class="grid grid-cols-4 min-[1281px]:grid-cols-8 gap-y-6 gap-x-4">
                ...
                <a href="{{ route('user-pelatihan.index') }}"
                    ...
                    <span class="text-xs font-semibold text-slate-700 mt-2 text-center leading-tight">E-Pelatihan</span>
                </a>
                ...
                <!-- Menu 3 -->
                <a href="{{ url('/surat') }}" class="menu-item-auth flex flex-col items-center cursor-pointer group">
                    <div
                ...
                <a href="{{ route('user.artikel.index') ?? '#' }}" class="flex flex-col items-center cursor-pointer group">
                    <div
                        class="w-16 h-16 md:w-18 md:h-18 rounded-2xl bg-gradient-to-tr from-blue-600 to-cyan-700 flex items-center justify-center text-white shadow-md shadow-blue-500/20 group-hover:scale-105 transition">
                ...
                <a href="#" class="menu-item-auth flex flex-col items-center cursor-pointer group">
                    ...
                    <span class="text-xs font-semibold text-slate-700 mt-2 text-center leading-tight">Korwil</span>
                </a>

                <!-- Menu 6 -->
                <a href="{{ url('/about') }}" class="menu-item-auth flex flex-col items-center cursor-pointer group">
                    <div
    ...
    <div id="loginModal"
        ...
        <div id="modalContent"
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-xs text-slate-500 mt-1">Silakan pilih opsi di bawah ini untuk mengakses menu eksklusif
                    BAKUMDA.</p>
            </div>
