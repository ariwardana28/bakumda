...
@section('content')
        ...
        <div class="px-5 mb-6">
            ...
            <div class="grid grid-cols-4 gap-3 sm:gap-4 md:gap-5">
                ...
                <a href="javascript:void(0)" onclick="showAuthModal()"
                    ...
                    <span
                        class="text-[11px] sm:text-xs md:text-sm font-semibold text-gray-700 mt-2 text-center">Marchaindise</span>
                </a>
                ...
                <a href="javascript:void(0)" onclick="showAuthModal()"
                    ...
                    <span
                        class="text-[11px] sm:text-xs md:text-sm font-semibold text-gray-700 mt-2 text-center">Dokumen</span>
                </a>
    ...
    <!-- Auth Modal -->
    <div id="authModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-5 hidden">
        <div class="bg-white rounded-3xl shadow-xl w-full max-w-sm p-6 text-center transform transition-all scale-95 opacity-0 relative"
            id="authModalContent">
            <div
                class="w-16 h-16 mx-auto bg-orange-100 rounded-full flex items-center justify-center text-orange-500 mb-4">
                <i class="fa-solid fa-lock text-3xl"></i>
            </div>
            <h3 class="text-lg font-bold text-gray-900">Akses Terbatas</h3>
            <p class="text-sm text-gray-600 mt-2 mb-6">
                Untuk mengakses layanan ini, Anda harus masuk atau mendaftar terlebih dahulu.
            </p>
            <div class="space-y-3">
                <a href="{{ route('login') }}"
                    class="block w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-5 rounded-xl transition duration-300">
                    Masuk (Login)
                </a>
                <a href="{{ route('register') }}"
                    class="block w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-3 px-5 rounded-xl transition duration-300">
                    Daftar Akun Baru
                </a>
            </div>
            <button onclick="hideAuthModal()" class="text-gray-400 hover:text-gray-600 absolute top-4 right-4">
