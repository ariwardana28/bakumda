...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <h2 class="text-3xl font-bold text-gray-800 dark:text-white tracking-tight">Edit Data & Role User</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi profil, kredensial, dan hak akses role pengguna.</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden p-6 sm:p-8">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Password Baru <span class="text-xs font-normal text-gray-400">(Opsional)</span></label>
                ...
                <div class="md:col-span-2 pt-2">
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Atur Hak Akses Role</label>
                    ...
                    @error('roles')
                        <p class="text-rose-500 text-xs mt-2 font-medium flex items-center gap-1">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            {{ $message }}
                        </p>
                    @enderror
