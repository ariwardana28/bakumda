...
@section('content')
    <div class="container mx-auto">
        ...
        <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            <a href="{{ url('/user-pelatihan') }}" class="hover:text-blue-600 transition-colors">Daftar Pelatihan</a>
            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <span class="text-gray-800 font-semibold truncate">{{ $pelatihan->judul ?? 'Detail Pelatihan Hukum' }}</span>
        </nav>

        {{-- Layout Utama 2 Kolom (Konten Kiri & Sidebar Kanan) --}}
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">

            {{-- KOLOM KIRI (Konten Utama Detail & Informasi) --}}
            <div class="lg:col-span-2 space-y-8">

                {{-- Header Banner / Gambar Pelatihan (Terpisah dari Judul) --}}
                <div class="rounded-3xl overflow-hidden bg-slate-900 shadow-xl border border-gray-100">
                    <div class="relative h-72 md:h-96 w-full">
                        ...
                        @else
                            <div
                                class="flex flex-col items-center justify-center h-full text-gray-400 space-y-2 bg-gradient-to-br from-slate-900 via-blue-950 to-gray-900">
                                <svg class="w-16 h-16 text-blue-400/50" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                                <span class="text-sm font-medium text-gray-300">Pusat Sertifikasi & Pelatihan Hukum</span>
                            </div>
                        @endif
                    </div>
                </div>

                {{-- Judul & Badge Kategori (Kini Terpisah di Luar Gambar) --}}
                <div class="space-y-4">
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            class="px-3.5 py-1.5 bg-blue-600 text-white rounded-full text-xs font-bold tracking-wide uppercase shadow-sm">
                            Sertifikasi Hukum
                        </span>
                        <span
                            class="px-3.5 py-1.5 bg-emerald-600 text-white rounded-full text-xs font-bold tracking-wide shadow-sm">
                            {{ isset($pelatihan->harga) && $pelatihan->harga == 0 ? 'Gratis' : 'Berbayar' }}
                        </span>
                    </div>
                    <h1 class="text-2xl md:text-4xl font-extrabold tracking-tight text-gray-900 leading-tight">
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-start gap-4 p-4 rounded-2xl bg-blue-50/50 border border-blue-100">
                            <div class="p-2 bg-blue-600 text-white rounded-xl shadow-md">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">Mendapatkan e-sertifikat kelulusan berstandar resmi
                                    yang diakui dalam portofolio keahlian.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">Akses penuh ke modul materi pembelajaran hukum,
                                    rekaman sesi, dan draf dokumen pendukung.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 rounded-2xl bg-indigo-50/50 border border-indigo-100">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">Terhubung langsung dengan komunitas praktisi hukum,
                                    advokat, dan profesional lintas sektor.</p>
                            </div>
                        </div>

                        <div class="flex items-start gap-4 p-4 rounded-2xl bg-amber-50/50 border border-amber-100">
                            <div class="p-2 bg-amber-600 text-white rounded-xl shadow-md">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">Sesi interaktif live Q&A bersama narasumber ahli untuk
                                    membedah studi kasus nyata.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm text-gray-600">
                            <li class="flex items-start gap-3">
                                <span
                                    class="flex-shrink-0 w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">1</span>
                                <span>Peserta terdaftar wajib mengisi formulir pendaftaran dengan data diri yang valid
                                    sesuai kartu identitas (KTP/KTA).</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span
                                    class="flex-shrink-0 w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">2</span>
                                <span>Melakukan pelunasan biaya administrasi (jika pelatihan berbayar) dan mengunggah bukti
                                    transfer pada sistem paling lambat 1 hari sebelum acara dimulai.</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span
                                    class="flex-shrink-0 w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">3</span>
                                <span>Kehadiran peserta dalam sesi pelatihan online/offline minimal 85% dari total durasi
                                    guna memenuhi syarat penerbitan sertifikat.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-700">
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                ...
                                <span>Scan / Foto KTP / Kartu Identitas Sah</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span>Pasfoto formal latar belakang bebas rapi</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span>Nomor WhatsApp aktif untuk grup koordinasi</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span>Alamat Email aktif untuk pengiriman e-sertifikat</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sticky top-8 bg-white rounded-3xl p-6 md:p-7 shadow-xl border border-gray-100 space-y-6">
                    ...
                    <div class="space-y-4 text-sm text-gray-600 font-medium">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-emerald-600 font-bold">{{ $pelatihan->kuota ?? '45' }} Peserta
                                Tersedia</span>
                        </div>
                    ...
                    <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                        <p class="text-xs text-gray-500">Butuh bantuan pendaftaran atau konfirmasi pembayaran?</p>
                        <a href="https://wa.me/" target="_blank"
                            class="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-600 hover:text-emerald-500 mt-1">
