...
<body class="min-h-screen text-gray-800 flex flex-col items-center justify-start p-0 md:p-6 transition-all duration-300">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar pt-24 pb-32">
                    ...
                    <div id="cardSlider"
                        ...
                        @forelse ($pelatihans as $pelatihan)
                            <div
                                ...
                                <div class="z-10">
                                    <button onclick="handleProtectedAction('{{ route('user-pelatihan.show', $pelatihan->id) }}')"
                ...
                <div class="mt-5 px-5 mb-6">
                    ...
                    <div class="grid grid-cols-4 gap-3 sm:gap-4">
                        ...
                        <!-- Menu: Kartu -->
                        <div onclick="handleProtectedAction('{{ route('kartu-anggota.cek.form') }}')" class="flex flex-col items-center cursor-pointer group">
                        ...
                        <!-- Menu: Pelatihan -->
                        <div onclick="handleProtectedAction('{{ route('user-pelatihan.index') }}')" class="flex flex-col items-center cursor-pointer group">
                            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-orange-100/70 border border-orange-200 flex items-center justify-center text-orange-500 shadow-sm group-hover:scale-105 transition">
                        ...
                        <!-- Menu: Sertifikat -->
                        <div onclick="handleProtectedAction('{{ route('sertifikat.cek.form') }}')" class="flex flex-col items-center cursor-pointer group">
                            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-orange-100/70 border border-orange-200 flex items-center justify-center text-orange-500 shadow-sm group-hover:scale-105 transition">
                        ...
                        <!-- Menu: Artikel -->
                        <div onclick="handleProtectedAction('#')" class="flex flex-col items-center cursor-pointer group">
                            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-orange-100/70 border border-orange-200 flex items-center justify-center text-orange-500 shadow-sm group-hover:scale-105 transition">
    ...
    <div id="loginRequiredModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300 p-4">
        <div id="loginModalContent" class="bg-white w-full max-w-sm rounded-[32px] p-6 shadow-2xl text-center transform scale-95 transition-all duration-300">
            <div class="w-16 h-16 bg-orange-100 text-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 text-2xl shadow-inner">
